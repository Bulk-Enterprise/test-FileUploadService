...
namespace AzureFileTransferService
{
    public class FileTransferService(ILogger<FileTransferService> logger) : BackgroundService
    {
        ...
        private readonly string _sqlConnectionString = "Server=tcp:sql-fileupload-cus.database.windows.net,1433;Initial Catalog=sqldb-fileupload-dev;Persist Security Info=False;User ID=svcdAzureFileAPI@nationaldentex.com;Password=sl0wSpar<45*!;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Authentication=Active Directory Password";
